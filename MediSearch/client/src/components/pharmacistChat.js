...
export default function GroupChat(){
    ...
    const sid = data.sid;
    const semail = localStorage.getItem("aemail");
        ...
        <div align='right' style={{width:'80rem'}}>
            ...
            <div className="scroll-bg" align='center'>
                            ...
                            chatArr.map((val, key) => {
                                ...
                                return(
                                    ...
                                    {val.sender === semail ? (
                                        ...
                                        <>
                                            {val.area === localStorage.getItem("aarea") ? (
                                            <div align='left'>
                ...
                <table className="mt-3">
                    <tr>
                        <td>
                        <input type="text" className="form-control" placeholder="Enter a message" style={{backgroundColor : 'transparent' ,borderColor : 'black', width:'68rem' }}
                        onChange = {(e) => {
