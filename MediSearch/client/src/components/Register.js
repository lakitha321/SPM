...
function Register() {
    ...
    const sendData = (e) => {
        ...
        axios.post("http://localhost:8040/civilian/", newCiviian).then((res)=>{
            alert(res.data);
            navigate("/log");
        }).catch((err)=>{
            alert(err);
    ...
    return (
        <div className="container">
            ...
            <Card>
            <Card.Body>
                <Card.Title>Client Registration Form</Card.Title><br/>
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    ...
                    <Form.Group as={Col} md="4" controlId="validationCustom05" className='mb-5'>
                    ...
                    <Form.Group as={Col} md="5" controlId="validationCustom05" className='mb-5 mt-5'>
